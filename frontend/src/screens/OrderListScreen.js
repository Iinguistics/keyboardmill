...
import { getAllOrders, orderDelivered, orderDetails } from '../actions/orderActions';
...
const OrderListScreen = ({ history, match }) => {
    ...
    const { order, loading:orderDeliveredLoading, error:orderDeliveredError } = orderDeliveredState;
